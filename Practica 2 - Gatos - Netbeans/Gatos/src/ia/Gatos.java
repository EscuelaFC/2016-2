...
public class Gatos extends PApplet {
    ...
    /**
     * Clase para representar un estado del juego del gato. Cada estado sabe
     * cómo generar a sus sucesores.
     */
    class Gato {
        ...
        LinkedList<Gato> generaSucesores() {
            ...
            // dejar sin padre a los sucesores.   s
        }

        boolean recorreListaGatos(LinkedList<Gato> gatos, Gato verificar ){
            for(Gato g : gatos)
    ...
    // ------- *** ------- *** -------
        ...
        /**
         * Rota el otro tablero 180° en la dirección de las manecillas del
         * reloj.
         */
        ...
        /**
         * Rota el otro tablero 270° en la dirección de las manecillas del
         * reloj.
         */
        ...
        /**
         * Devuelve una representación con caracteres de este estado. Se puede
         * usar como auxiliar al probar segmentos del código.
         */
        @Override
