...
public class Laberinto extends PApplet {
    ...
    class Modelo{
      ...
      /** 
       * <p>Elegiremos una direccion aleatoria, con numeros entre 1-4
       * segun lo que salga determina la direccion.<br> Posibles movimientos:</p>
       *                              | 1 |</br>
       *                          | 0 | c | 2 |</br>
       *                              | 3 |</br>
       *<p> Y por ultimos haremos que cada vez que nos movasemos a alguna 
       * la agregaremos a nuestra pilad
       * </p>
       ...
       */
        ...
        /**
         * Para movernos hacia la izquierda es necesario 
         * quitar la pared de la celda sobre la que 
         * estemos parados y quitaremos la pared de la nueva celda, la cual sera 
         * la contraria de la que hayamos quitado primero, en este caso seria 
         * quitar la pared izquierda de nuestra celda actual y quitar la derecha de 
         * la nueva a la que nos movemos.</br>
         */
